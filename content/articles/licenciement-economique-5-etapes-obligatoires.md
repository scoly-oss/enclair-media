...
1. **Documentez votre motif économique** avec des données chiffrées sur les trimestres requis. Pas de lettre sans chiffres.

2. **Lancez la recherche de reclassement avant tout le reste.** Interrogez toutes les entités du groupe par écrit, conservez les réponses.

3. **Formalisez les critères d'ordre** dans une note interne, appliquez-les avec une grille de notation documentée.

4. **Convocez le CSE** avec un dossier complet : motif économique, postes supprimés, critères d'ordre, mesures de reclassement.

5. **Ne brûlez pas les étapes.** Un licenciement économique sérieux prend au minimum 4 à 6 semaines pour un petit effectif, et plusieurs mois avec un PSE.
