...
1. **Comptez vos stagiaires** et vérifiez que vous respectez le quota (3 maximum pour moins de 20 salariés, 15 % au-delà).

2. **Vérifiez les conventions** : chacune doit être signée par les trois parties et mentionner les activités pédagogiques. Pas de convention = pas de stage légal.

3. **Évaluez les missions** confiées à chaque stagiaire : sont-elles réellement en lien avec leur formation ? Ou correspondent-elles à un poste de travail permanent ?

4. **Assurez le tutorat effectif** : le tuteur désigné doit réellement encadrer le stagiaire, pas simplement signer la convention.
