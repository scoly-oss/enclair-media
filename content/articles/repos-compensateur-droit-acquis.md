...
1. **Mettre en place un compteur individuel** de repos compensateurs dans le logiciel de paie
2. **Informer chaque mois** les salariés de leurs droits acquis (mention sur le bulletin de paie)
3. **Programmer des alertes** lorsque le compteur atteint 7 heures pour déclencher le délai de prise
4. **Organiser la prise des repos** de manière proactive, sans attendre la demande du salarié
5. **Provisionner** les repos acquis non pris (impact comptable sur les provisions pour charges de personnel)
6. **Solder les compteurs** en cas de rupture et verser l'indemnité compensatrice sur le solde de tout compte
