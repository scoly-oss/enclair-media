...
1. **Former** le référent dès sa désignation
2. **Définir** clairement ses missions dans le règlement intérieur du CSE
3. **Mettre à disposition** des outils de signalement confidentiels
4. **Organiser** une coordination entre le référent CSE et le référent employeur
5. **Évaluer** annuellement l'activité du référent et les actions de prévention menées
