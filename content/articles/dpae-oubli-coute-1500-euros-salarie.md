...
1. **Intégrez la DPAE dans votre processus de recrutement** : la DPAE doit être faite AVANT que le salarié ne franchisse la porte de l'entreprise, pas après.

2. **Automatisez** si possible : la plupart des logiciels de paie permettent de générer la DPAE directement. Utilisez cette fonctionnalité.

3. **Vérifiez les accusés de réception** : conservez-les pendant 5 ans minimum. En cas de contrôle URSSAF, c'est la première pièce demandée.

4. **Sensibilisez les managers** : le service RH n'est pas toujours informé en temps réel des prises de poste, surtout pour les CDD courts et les extras. Les managers doivent prévenir avant, pas après.

5. **Auditez vos pratiques** : comparez la liste de vos DPAE avec votre registre unique du personnel. Chaque salarié figurant au registre doit avoir une DPAE correspondante.
