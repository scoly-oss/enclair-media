---
title: "Droit à la déconnexion : l'obligation de négocier que vous n'avez pas remplie"
excerpt: "Depuis 2017, les entreprises de 50 salariés et plus doivent négocier sur le droit à la déconnexion. La plupart ne l'ont jamais fait. Le risque est réel."
date: "2025-07-08"
category: "droit-social"
tags: ["droit à la déconnexion", "NAO", "télétravail", "charge de travail"]
readTime: "5 min"
sources:
  - "Code du travail, article L.2242-17, 7°"
  - "Code du travail, article L.3121-64 (forfait jours)"
...
1. **Les plages horaires de déconnexion** : périodes pendant lesquelles les salariés n'ont pas l'obligation de répondre aux sollicitations professionnelles (par exemple, de 20h à 7h et les week-ends).

2. **Les dispositifs de régulation** : pop-up d'alerte lors de l'envoi d'emails tardifs, envoi différé automatique, coupure des serveurs de messagerie (rare mais efficace).

3. **Les exceptions** : situations d'urgence justifiant une dérogation (à définir précisément, pas de clause fourre-tout).

4. **Les actions de formation** : sensibilisation des managers et des salariés à la gestion des outils numériques.

5. **Le suivi** : indicateurs de surveillance (volume d'emails hors plages, connexions tardives) et bilan annuel.
...
1. **Vérifiez si vous avez un accord ou une charte** sur le droit à la déconnexion. Si la réponse est non et que vous avez 50 salariés ou plus, vous êtes en défaut.

2. **Inscrivez le sujet à l'ordre du jour** de votre prochaine NAO. C'est un thème obligatoire que vous ne pouvez pas ignorer.

3. **À défaut d'accord**, rédigez une charte unilatérale après consultation du CSE. C'est le minimum légal.

4. **Sensibilisez vos managers** : le droit à la déconnexion commence par le comportement de la hiérarchie. Un manager qui n'envoie pas d'emails le soir est le meilleur dispositif de déconnexion.

5. **Mettez en place des indicateurs** : volume d'emails envoyés hors plages horaires, taux de connexion le week-end. Ce que vous mesurez, vous pouvez l'améliorer.
