...
1. **Réaliser un diagnostic** des postes exposés en s'appuyant sur le DUERP (document unique d'évaluation des risques professionnels)
2. **Utiliser les référentiels de branche** lorsqu'ils existent, pour sécuriser l'évaluation
3. **Documenter les mesures de protection** mises en place (EPI, protections collectives) et leur impact sur les niveaux d'exposition
4. **Paramétrer la DSN** pour intégrer les déclarations C2P de manière fiable
5. **Informer les salariés** de leurs droits et du nombre de points acquis
6. **Anticiper les obligations de négociation** sur la prévention de la pénibilité si l'effectif exposé dépasse le seuil de 25 %
