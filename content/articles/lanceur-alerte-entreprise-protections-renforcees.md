...
1. Alerter par le **canal interne** de l'entreprise
2. Saisir directement une **autorité externe** compétente (Défenseur des droits, ACPR, AMF, ARS, etc.)
3. Procéder à une **divulgation publique** en dernier recours, si les canaux précédents n'ont pas donné de résultat dans les délais
...
1. **Mettre en place la procédure** de signalement si ce n'est pas déjà fait
2. **Désigner un référent** formé et indépendant
3. **Informer les salariés** de l'existence du dispositif et des modalités de saisine
4. **Former les managers** à réagir correctement en cas de signalement (ne pas entraver, ne pas exercer de représailles)
5. **Documenter le traitement** de chaque signalement pour démontrer la diligence de l'entreprise
