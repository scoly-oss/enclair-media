...
1. **Évaluez vos managers** non seulement sur leurs résultats, mais sur leurs méthodes de management. Un manager performant mais toxique est un risque juridique majeur.

2. **Mettez en place un canal de signalement** confidentiel permettant aux salariés de rapporter des comportements problématiques sans crainte de représailles.

3. **Formez vos managers** au management respectueux. Ce n'est pas du "développement personnel", c'est de la prévention des risques juridiques.

4. **Réagissez aux signaux d'alerte** : turnover élevé dans une équipe, absentéisme, plaintes récurrentes. Ces indicateurs doivent déclencher une enquête.

5. **En cas de signalement**, diligentez une enquête interne immédiate et impartiale. L'inaction est le pire scénario juridique.
